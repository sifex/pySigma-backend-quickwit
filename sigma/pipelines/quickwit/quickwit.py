...
@Pipeline
def quickwit_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        ...
        items=[
            ...
            ProcessingItem(     # Field mappings
                identifier="quickwit_field_mapping",
